...
{
	public class SupersonicBuildPostprocessor
	{
		[PostProcessBuild]
		public static void OnPostprocessBuild (BuildTarget buildTarget, string buildPath)
		{
			if (buildTarget == BuildTarget.iOS) {
				...
				string dirpath = Application.dataPath + "/Consoliads/Supersonic/Editor/";
			...
			Debug.Log ("Supersonic build postprocessor finished");
		}

		private static void updateProject (BuildTarget buildTarget, string projectPath)
		{
			Debug.Log ("Supersonic - Update project for Supersonic");
